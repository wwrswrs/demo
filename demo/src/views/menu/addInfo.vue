<template>
  ...
  <div>
    <!-- 弹框内容  props 是单项数据流 只能接收 不可以子组件直接修改 子组件想要修改父组件的数据要用子传父
    center是对头部底部采用居中布局-->
    <el-dialog
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="add('ruleForm')" v-if="addInfo.isAdd">确 定</el-button>
         <el-button type="primary" @click="update('ruleForm')" v-else>编辑</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
// console.log(indexRoutes,"indexRoutes111111")
