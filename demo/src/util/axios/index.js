...
//后台管理接口集合
// ==============菜单列表=============
//封装菜单列表接口 istree=true是可选参数。如果加上他就会返回树级结构
...
export function deleteMenu(data) {
  return http.post("/api/menudelete", data)//posts的参数是一个data的数据
}
...
// ==============角色列表=============
//封装角色列表接口 istree=true是可选参数。如果加上他就会返回树级结构
...
export function deleteRole(data) {
  return http.post("/api/roledelete", data)//posts的参数是一个data的数据
}
...
export function deleteManger(data) {
  return http.post("/api/userdelete", data)//posts的参数是一个data的数据
}
...
export function getMangerCount() {
  return http.get("/api/usercount")//get是一个对象参数是params   是一个对象
...
export function getCateInfo(params) {
  return http.get("/api/cateinfo", { params })//posts的参数是一个data的数据
}

//获取管理员编辑一条接口的数据
export function getCateEdit(data) {
  return http.post("/api/cateedit", data)//get是一个对象参数是params   是一个对象
